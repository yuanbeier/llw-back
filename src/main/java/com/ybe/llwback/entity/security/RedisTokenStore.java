 ...
 * @author:beier
 * @date:2020/3/10
 * @description:原因是spring-data-redis 2.0版本中set(String, String)被弃用了
 * ，要使用RedisConnection.stringCommands().set(…)，所有我自定义一个RedisTokenStore
 * ，代码和RedisTokenStore一样，只是把所有conn.set(…)都换成
 * conn..stringCommands().set(…)，测试后方法可行。
 * @verison:1.0
 */
@Configuration
@Primary
